...
>(options?: { name?: string; debug?: boolean }) {
  ...
  // didn't change the import to `react-navigation-shared-element/stack-v4`.
  if (
    options &&
    ...
    throw new Error(
      `Invalid options specified to 'createSharedElementStackNavigator'. If you are using react-navigation 4, please import from 'react-navigation-shared-element/stack-v4'`
    );
  }
